...
import type { Route } from './+types/email-accounts.aol.start';
...
import { createAolAuthorizationUrl } from '~/services/email/aol.server';
...
export const loader = async ({ request, context }: Route.LoaderArgs) => {
  ...
  return redirect(createAolAuthorizationUrl({ clientId, redirectUri, state }));
};
