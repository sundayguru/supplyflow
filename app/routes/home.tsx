...
const SectionHeading = ({
  ...
  <div className={centered ? 'mx-auto max-w-2xl text-center' : 'max-w-2xl'}>
    <p className='mb-4 text-xs font-bold tracking-[0.2em] text-emerald-700 uppercase'>
      {eyebrow}
    </p>
    <h2 className='font-serif text-4xl leading-[1.05] font-semibold tracking-tight text-slate-950 sm:text-5xl'>
      {title}
    </h2>
...
const LandingPage = () => {
  ...
  return (
    <main className='min-h-screen overflow-hidden bg-[#f7f8f4] font-sans text-slate-950'>
        ...
        <div className='relative z-10 mx-auto grid max-w-7xl items-center gap-14 px-5 py-20 sm:px-8 sm:py-28 lg:grid-cols-[1.05fr_0.95fr] lg:px-10 lg:py-32'>
          <div>
            ...
            <p className='mt-7 max-w-xl text-lg leading-8 text-slate-600'>
              ...
              reuses pricing intelligence, and reveals what converts—all in one
          ...
          <div className='relative mx-auto w-full max-w-xl'>
            ...
            <div className='relative rounded-[2rem] border border-white/80 bg-white/85 p-4 shadow-[0_30px_80px_-30px_rgba(15,23,42,0.35)] backdrop-blur sm:p-6'>
              ...
              <div className='absolute -right-3 -bottom-5 flex items-center gap-3 rounded-2xl border border-emerald-100 bg-white p-3 shadow-xl sm:-right-8 sm:p-4'>
      ...
      <section id='problem' className='bg-slate-950 py-20 text-white sm:py-28'>
          ...
          <div className='grid gap-3'>
            {problems.map((problem, index) => (
              ...
              >
                ...
                <p className='text-sm text-slate-200 sm:text-base'>{problem}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id='results' className='px-5 pb-20 sm:px-8 sm:pb-28 lg:px-10'>
        <div className='mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-[#dff7e8] px-6 py-12 sm:px-10 lg:px-14 lg:py-16'>
          <div className='grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-end'>
            ...
            <div className='grid grid-cols-2 gap-3 sm:gap-4'>
              {benefits.map(({ value, label, icon: Icon }) => (
                <div key={label} className='rounded-2xl bg-white/75 p-4 sm:p-5'>
                  <Icon
      ...
      <section className='px-5 pb-20 sm:px-8 sm:pb-28 lg:px-10'>
        <div className='relative mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-emerald-700 px-6 py-14 text-center text-white sm:px-10 sm:py-20'>
